<template>
    <div :pid="pid" :class="[
        ...
        <svg v-if="this.displayDate && shownClear && !disabled" class="v2-date-clear" @click.stop="clearDate" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16">
